    ...
    >
      ...
      <div className="flex flex-col gap-6 justify-center items-center sm:gap-8 lg:flex-row lg:px-12 lg:items-stretch 2xl:gap-12">
        <img
          ...
          className="shadow-custom object-cover border-2 border-gold w-full md:w-3/4 lg:w-4/6 2xl:w-4/6"
        />
        <div className="font-raleway flex flex-col gap-12 justify-between text-base font-light text-justify text-white sm:text-2xl md:w-7/8 md:text-lg lg:gap-24 lg:tracking-wide 2xl:text-xl 2xl:w-5/6">
          <p>
