  ...
  return (
    <>
      ...
      >
        ...
        <div className="font-raleway text-white font-normadal text-center leading-5 tracking-widest mb-12 sm:text-2xl sm:leading-7 lg:text-lg xl:w-7/8 xl:text-xl 2xl:w-4/6 animate-[fadeIn_1s_ease-in]">
